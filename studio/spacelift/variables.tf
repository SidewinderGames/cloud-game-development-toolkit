...
variable "agent_ami_id" {
  description = "AMI ID for the Linux Horde build agents. Empty string disables the Linux pool entirely (matches Phase 2's default). Eventually a warm AMI with the project pre-synced."
  type        = string
  default     = ""
}
